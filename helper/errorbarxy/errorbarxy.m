...
%   Created by Qi An
%   anqi2000@gmail.com
%   Developed further by Martin Schrimpf
...
if iscell(varargin{end}) || ischar(varargin{end}) % search for formatting strings
    color=varargin{end};
