...
featureExtractors = {...
    ...
    HopFeatures(BipolarFeatures(0.01, featureProviderFactory.get(HmaxFeatures()))); ...
    HopFeatures(BipolarFeatures(0, featureProviderFactory.get(AlexnetPool5FeaturesKlabData()))); ...
    HopFeatures(BipolarFeatures(0, featureProviderFactory.get(AlexnetFc7FeaturesKlabData()))); ...
