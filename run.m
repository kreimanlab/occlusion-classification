...
featureExtractors = {...
    ...
    HopFeatures(BipolarTrainFeatures(0.01, featureProviderFactory.get(HmaxFeatures()))); ...
    HopFeatures(BipolarTrainFeatures(0, featureProviderFactory.get(AlexnetPool5FeaturesKlabData()))); ...
    HopFeatures(BipolarTrainFeatures(0, featureProviderFactory.get(AlexnetFc7FeaturesKlabData()))); ...
