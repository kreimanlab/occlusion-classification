...
featureExtractors = {...
    ...
    hop(BipolarTrainFeatures(0, featureProviderFactory.get(AlexnetPool5FeaturesKlabData()))); ...
    hop(BipolarTrainFeatures(0, featureProviderFactory.get(AlexnetFc7FeaturesKlabData()))); ...
