...
%     };
% figs = plotWholeVsOccludedTsne(featureExtractors, '6B-tsne_vs_time');
...
% % overall
% figures(end + 1) = figure('Name', '6F_A-correspondence_vs_time (correct)');
% plotCorrespondenceOverTime(timeResults, 'correct', 'correct');
% % exemplar confusion matrices
% figures(end + 1) = figure('Name', '6F_A_S1-confusion_exemplars (correct)');
% plotConfusionMatricesOverTime(correlationExemplarResults, ...
%     'correct', 'correct', {'N', 'C'});
%% correspondence vs time response
% overall
figures(end + 1) = figure('Name', '6F_B-correspondence_vs_time (response)');
plotCorrespondenceOverTime(timeResults, 'response', 'response_category');
% exemplar confusion matrices
figures(end + 1) = figure('Name', '6F_B_S1-confusion_exemplars (response)');
plotConfusionMatricesOverTime(correlationExemplarResults, ...
